    ...
    public class TestData
    {
        public static Level FirstLevel(Vec movingObjectPosition)
        {
            ...
            var testCells = new[]
            {
                ...
                new CellDto("38", new Vec(4, 4), "box", "", 0),
                new CellDto("39", new Vec(4, 6), "box", "", 0),
                new CellDto("40", new Vec(3, 6), "boxOnTarget", "", 0),
                new CellDto("41", new Vec(5, 6), "box", "", 0),
                new CellDto("42", new Vec(1, 6), "box", "", 0),
